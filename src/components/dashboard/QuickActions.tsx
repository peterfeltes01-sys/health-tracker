  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center gap-3 bg-accent-50 dark:bg-orange-950/30 border border-accent-100 dark:border-orange-900/50 rounded-2xl p-4 text-left active:scale-95 transition-transform"
      >
        <div className="w-10 h-10 bg-accent-500 rounded-xl flex items-center justify-center flex-shrink-0">
          <Plus size={20} className="text-white" />
        </div>
        <div>
          <div className="font-semibold text-accent-700 dark:text-accent-400 text-sm">Aktivität hinzufügen</div>
          <div className="text-xs text-accent-600/70 dark:text-accent-500/70">Training, Radfahren, Laufen …</div>
        </div>
      </button>
